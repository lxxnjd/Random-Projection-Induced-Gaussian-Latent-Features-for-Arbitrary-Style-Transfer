...
# python test.py --content input/c2/2.jpg --style input/style/1.jpg --crop --decoder models/efdm_decoder_iter_160000.pth.tar
...
def style_transfer(vgg, decoder, content, style, alpha=1.0,
    ...
    decode_start.record()  # Start timing
    output = decoder(feat)
    decode_end.record()  # End timing
    torch.cuda.synchronize()
    decode_time = decode_start.elapsed_time(decode_end)
    print(f"Decoding time consumption: {decode_time:.2f} ms")
